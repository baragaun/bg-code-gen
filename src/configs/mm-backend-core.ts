...
const classes: BgCodeGenClassConfig[] = [
  {
    ...
    attributes: [
      ...
      { name: 'authTokenCreatedAt', dataType: 'date', default: '', optional: true },
      { name: 'oAuthTokenExpiresAt', dataType: 'date', default: '', optional: true },
      { name: 'avatarUrl', dataType: 'string' },
      { name: 'email', dataType: 'string' },
      { name: 'emailUpdatedAt', dataType: 'date', default: '', optional: true },
      ...
      { name: 'passwordUpdatedAt', dataType: 'date', default: '', optional: true },
      { name: 'phoneNumber', dataType: 'string' },
      { name: 'phoneNumberUpdatedAt', dataType: 'date', default: '', optional: true },
      ...
      { name: 'signedInAt', dataType: 'date', default: '', optional: true },
      { name: 'signedOutAt', dataType: 'date', default: '', optional: true },
