...
const sidUserDeviceInput: TypeGraphqlClass = {
  name: 'SidUserDeviceInput',
  graphqlType: GraphqlType.InputType,
  extends: 'BaseModelInput',
  path: 'src/services/secureId/types/classes/SidUserDeviceInput.ts',
  active: true,
  attributes: [
...
export default sidUserDeviceInput
